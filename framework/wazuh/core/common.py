...
GROUP_NAME = 'wazuh'
USER_NAME = 'wazuh'
WAZUH_PATH = os.environ.get("WAZUH_PATH") or find_wazuh_path()
WAZUH_DATA_PATH = os.environ.get("WAZUH_DATA_PATH") or find_wazuh_path()
...
# ================================================ Wazuh path - Config =================================================
OSSEC_CONF = os.path.join(WAZUH_DATA_PATH, 'etc', 'ossec.conf')
INTERNAL_OPTIONS_CONF = os.path.join(WAZUH_DATA_PATH, 'etc', 'internal_options.conf')
LOCAL_INTERNAL_OPTIONS_CONF = os.path.join(WAZUH_DATA_PATH, 'etc', 'local_internal_options.conf')
AR_CONF = os.path.join(WAZUH_DATA_PATH, 'etc', 'shared', 'ar.conf')
CLIENT_KEYS = os.path.join(WAZUH_DATA_PATH, 'etc', 'client.keys')
SHARED_PATH = os.path.join(WAZUH_DATA_PATH, 'etc', 'shared')


# ================================================= Wazuh path - Misc ==================================================
WAZUH_LOGS = os.path.join(WAZUH_DATA_PATH, 'logs')
WAZUH_LOG = os.path.join(WAZUH_LOGS, 'ossec.log')
WAZUH_LOG_JSON = os.path.join(WAZUH_LOGS, 'ossec.json')
DATABASE_PATH = os.path.join(WAZUH_DATA_PATH, 'var', 'db')
DATABASE_PATH_GLOBAL = os.path.join(DATABASE_PATH, 'global.db')
ANALYSISD_STATS = os.path.join(WAZUH_DATA_PATH, 'var', 'run', 'wazuh-analysisd.state')
REMOTED_STATS = os.path.join(WAZUH_DATAPATH, 'var', 'run', 'wazuh-remoted.state')
OSSEC_TMP_PATH = os.path.join(WAZUH_DATA_PATH, 'tmp')
OSSEC_PIDFILE_PATH = os.path.join(WAZUH_DATA_PATH, 'var', 'run')
OS_PIDFILE_PATH = os.path.join('var', 'run')
WDB_PATH = os.path.join(WAZUH_DATA_PATH, 'queue', 'db')
STATS_PATH = os.path.join(WAZUH_DATA_PATH, 'stats')
BACKUP_PATH = os.path.join(WAZUH_DATA_PATH, 'backup')
MULTI_GROUPS_PATH = os.path.join(WAZUH_DATA_PATH, 'var', 'multigroups')
DEFAULT_RBAC_RESOURCES = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), 'rbac', 'default')


# ================================================ Wazuh path - Sockets ================================================
ANALYSISD_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'sockets', 'analysis')
AR_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'alerts', 'ar')
EXECQ_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'alerts', 'execq')
AUTHD_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'sockets', 'auth')
WCOM_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'sockets', 'com')
LOGTEST_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'sockets', 'logtest')
UPGRADE_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'tasks', 'upgrade')
REMOTED_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'sockets', 'remote')
TASKS_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'tasks', 'task')
WDB_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'db', 'wdb')
WMODULES_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'sockets', 'wmodules')
QUEUE_SOCKET = os.path.join(WAZUH_DATA_PATH, 'queue', 'sockets', 'queue')


# ================================================ Wazuh path - Ruleset ================================================
RULESET_PATH = os.path.join(WAZUH_DATA_PATH, 'ruleset')
...
USER_LISTS_PATH = os.path.join(WAZUH_DATA_PATH, 'etc', 'lists')
USER_RULES_PATH = os.path.join(WAZUH_DATA_PATH, 'etc', 'rules')
USER_DECODERS_PATH = os.path.join(WAZUH_DATA_PATH, 'etc', 'decoders')
